...
class ViewSkillSec extends StatefulWidget{
  final Skill skill;
  final Profile user;
  ...
  @override
  ViewSkillSecState createState() => ViewSkillSecState(user: user, skill: skill);
}

class ViewSkillSecState extends State<ViewSkillSec> {
  final Skill skill;
  final Profile user;
  ...
  void _submit() async {
    ...
    if (dropdownValue != null) {
            ...
            exchange.whoWantMail = dropdownValue.status == 2? CurrentUser.profile.email: skill.userMail;
      ...
      child: Container(
        ...
        decoration: new BoxDecoration(
            ...
            image: new DecorationImage(
              ...
              image:
              (user.photoUri == null ||
                  user.photoUri.isEmpty)
                  ? null
                  : MemoryImage(user.photoUri), //MemoryImage(CurrentUser.profile.photoUri),
            )),
      ),
    );
  }
            ...
            new Column(
              ...
              children: <Widget>[
                new GestureDetector(
                  onTap: null,
                  child: new Container(
                    padding: EdgeInsets.only(left: 7.0, top: 17.0),
                    child: new Text(
                      user.name +
                          " " +
                          user.surname,
