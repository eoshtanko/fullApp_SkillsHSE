...
class EmailForRecovery extends StatefulWidget {
  @override
  EmailForRecoveryState createState() => EmailForRecoveryState();
}

class EmailForRecoveryState extends State<EmailForRecovery> {
  ...
  void _onPressed() {
    ...
    if (form.validate()) {
      dialogLoading.show();
      form.save();
      Api.recovery(email.toLowerCase())
          .then((value) =>
      {
        dialogLoading.stop(),
